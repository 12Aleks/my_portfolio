...
export const workProjects = [
    {
        id: 1,
        name: "Nowa strona korporacyjna Termaheat",
    ...
    {
        id: 4,
        name: "Strona korporacyjna Termaplay",
        description: "Backend i Frontend wielejezycznej strony na podstawie layoutu z Figma",
    ...
    {
        id: 5,
        name: "Strona korporacyjna TermaRech",
        description: "Backend i Frontend wielejezycznej strony na podstawie layoutu z Figma",
        technologies: ['CMS Drupal 9', 'Bootstrap', 'Twig', 'JavaScript', 'SCSS', 'HTML'],
        date: "2022-10",
        image: "termareh.webp",
    ...
    {
        id: 8,
        name: "Strona korporacyjna TermaDrilling",
        description: "Backend i Frontend wielejezycznej strony na podstawie layoutu z Figma",
        technologies: ['CMS Drupal 10', 'Bootstrap', 'Twig', 'JavaScript', 'SCSS', 'HTML'],
        date: "2021-08",
    ...
    {
        id: 9,
        name: "Strona korporacyjna TermaFiber",
