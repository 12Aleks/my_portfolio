...

            {
              ...
              <span className="relative w-13 h-13 p-2.5 2xl:w-13 2xl:h-13 2xl:p-2.5 3xl:w-14 3xl:h-14 3xl:p-3 transition-all
                ...
                >
                    ...
                    <span className={clsx(labelDirection === 'left'? 'right-full left-auto': '', "absolute hidden peer-hover:block px-2 py-1 mx-2 left-full top-1/2 -translate-y-1 bg-background text-sm rounded-md shadow-lg whitespace-nowrap")}>
                        {label}
                    </span>
                </span>
                            </NavLink>
